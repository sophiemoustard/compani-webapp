<template>
  <q-list class="no-border sidemenu-alenvi sidemenu-flex">
    ...
    <q-separator />
    <ni-side-menu-footer :is-auxiliary-without-company="isAuxiliaryWithoutCompany" :label="userFirstnameUpper" :userId="user._id" @myClick="connectToBotMessenger" isAuxiliary />
  </q-list>
</template>
