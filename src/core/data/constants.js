...
export const FILL_THE_GAPS_MIN_ANSWERS_COUNT = 3;
export const FILL_THE_GAPS_MAX_ANSWERS_COUNT = 8;
export const FILL_THE_GAPS_MAX_GAPS_COUNT = 2;
export const QUESTION_OR_TITLE_MAX_LENGTH = 170;
