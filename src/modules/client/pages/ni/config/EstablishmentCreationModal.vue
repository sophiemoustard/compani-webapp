<template>
  <ni-modal :value="value" @hide="hide" @input="input">
      ...
      <ni-input in-modal caption="Nom" v-model="newEstablishment.name" :error="validations.name.$error"
        :error-message="establishmentNameError" @blur="validations.name.$touch"
        required-field />
      <ni-input in-modal caption="SIRET" v-model="newEstablishment.siret" :error="validations.siret.$error"
        :error-message="establishmentSiretError" @blur="validations.siret.$touch"
        required-field />
      <ni-search-address in-modal v-model="newEstablishment.address" color="white"
        @blur="validations.address.$touch" :error-message="establishmentAddressError"
      ...
      <ni-input in-modal caption="Téléphone" v-model="newEstablishment.phone" :error="validations.phone.$error"
        :error-message="establishmentPhoneError" @blur="validations.phone.$touch"
        required-field />
      <ni-select in-modal caption="Service de santé du travail" v-model="newEstablishment.workHealthService"
        ...
        :error-message="establishmentWhsError" @blur="validations.workHealthService.$touch"
        required-field />
      <ni-select in-modal caption="Code URSSAF" v-model="newEstablishment.urssafCode" :options="urssafCodes"
        ...
        :error-message="establishmentUrssafCodeError" required-field />
...
export default {
  ...
  props: {
    ...
    establishmentNameError: { type: String, default: '' },
    establishmentSiretError: { type: String, default: '' },
    establishmentAddressError: { type: String, default: '' },
    establishmentPhoneError: { type: String, default: '' },
    establishmentWhsError: { type: String, default: '' },
    establishmentUrssafCodeError: { type: String, default: '' },
